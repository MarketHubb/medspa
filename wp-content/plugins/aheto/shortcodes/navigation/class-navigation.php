...
class Navigation extends Shortcode {
	...
	public function setup() {
		...
		$this->add_dependecy( 'use_menu_link_typo', 'template', [ 'layout8'] );
		$this->add_dependecy( 'menu_link_typo', 'template', [ 'layout8'] );
	...
	public function set_params() {
		$this->params = [
			...
			'use_mob_menu_title_typo' => [
				'type'    => 'switch',
				'heading' => esc_html__( 'Use custom font for Mobile menu title?', 'snapster' ),
				'grid'    => 3,
			],
			'mob_menu_title_typo' => [
				'type'     => 'typography',
			...
			'use_mega_menu_title_typo' => [
				'type'    => 'switch',
				'heading' => esc_html__( 'Use custom font for Mega menu title?', 'snapster' ),
				'grid'    => 3,
			],
			...
			'use_menu_link_typo' => [
				'type'    => 'switch',
				'heading' => esc_html__( 'Use custom font for Menu links?', 'snapster' ),
				'grid'    => 3,
			],
			'menu_link_typo' => [
				'type'     => 'typography',
				...
				'selector' => '{{WRAPPER}} .main-header__menu-box .main-menu li a, {{WRAPPER}} .main-header__menu-box>ul li a',
			],
			'use_logo_typo' => [
				'type'    => 'switch',
				'heading' => esc_html__( 'Use custom font for Logo?', 'snapster' ),
				'grid'    => 3,
			],
			'logo_typo' => [
				'type'     => 'typography',
		...
		\Aheto\Params::add_button_params($this, [
			...
			'icons'      => true,
			'dependency' => ['template', ['layout5', 'layout7', 'layout8']]
		]);

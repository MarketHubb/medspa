            ...
            if (btnStyling) {
                ...
                [...btnItem].forEach((elem) => {
                    if (elem) {
                        ...
                        let btnFontSize = elem.querySelector('input[id*="_font_size"]') ? elem.querySelector('input[id*="_font_size"]') : elem.querySelector('input[id*="_0_font_font_size"]') ? elem.querySelector('input[id*="_0_font_font_size"]') : '';
                        let btnLineHeight = elem.querySelector('input[id*="_line_height"]') ? elem.querySelector('input[id*="_line_height"]') : elem.querySelector('input[id*="_0_font_line_height"]') ? elem.querySelector('input[id*="_0_font_line_height"]') : '';
                        let btnLetterSpasing = elem.querySelector('input[id*="_letter_spacing"]') ? elem.querySelector('input[id*="_0_font_letter_spacing"]') : '';
